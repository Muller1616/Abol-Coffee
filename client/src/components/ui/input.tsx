      ...
      <div className="space-y-2">
        <div className="relative">
          <input
            ...
            placeholder=" "
            className={cn(
              'peer h-14 w-full rounded-2xl border bg-white/70 px-4 pt-5 pb-2 text-sm text-foreground shadow-[inset_0_1px_0_rgb(255_255_255/0.65)] outline-none transition-all duration-200 backdrop-blur',

...
/** Professional empty state when a public menu token is missing or invalid. */
export function MenuNotFoundPage() {
  return (
    <main className="relative mx-auto flex min-h-dvh w-full max-w-lg flex-col items-start justify-center px-6 py-16">
      <DocumentTitle title="Menu not found · Abol Coffee" />
      ...
      <p className="mt-3 text-muted-foreground">
        This public menu link is invalid or no longer available. Ask the restaurant for their
        current QR code.
      </p>
